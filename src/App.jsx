...
export default function App() {
  ...
  const submitDirect = async () => {
    if ((form.website||"").trim() !== "") { setStatus({ type:"ok", note:"Thanks!" }); setForm({ name:"", email:"", company:"", message:"", website:"" }); return; }
      ...
      <section className="mx-auto max-w-7xl px-4 pt-14 pb-10 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            ...
            <a href="#contact" className="px-5 py-3 rounded-2xl border border-yellow-500 text-yellow-600 inline-flex items-center gap-2">Contact us</a>
          </div>
